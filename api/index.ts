...
import departmentsHandler from './departments'
import authHandler from './auth/[action]'
import authVerificationRequestHandler from './auth/verification/request'
import authVerificationConfirmHandler from './auth/verification/confirm'
import reportsHandler from './reports/index'
import reportsActionHandler from './reports/[id]/[action]'
import reportsTrackHandler from './reports/track/[trackingId]'
import notificationsHandler from './notifications/index'
import notificationsReadAllHandler from './notifications/read-all'
import notificationsUnreadCountHandler from './notifications/unread-count'
import notificationReadHandler from './notifications/[id]/read'
import dashboardsHandler from './dashboards/[type]'
import analyticsHandler from './analytics/[type]'
