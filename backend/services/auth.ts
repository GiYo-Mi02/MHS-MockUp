...
export function getTokenFromCookies(req: RequestLike): string | null {
...
export function setAuthCookie(res: ResponseLike, token: string): void {
...
export function clearAuthCookie(res: ResponseLike): void {
  res.setHeader(
    'Set-Cookie',
...
export function requireAuth(req: RequestLike, res: ResponseLike): TokenPayload | null {
