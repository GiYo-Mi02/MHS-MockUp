...
// GET /api/reports - Get report history for authenticated citizen
...
// GET /api/reports/track/:trackingId - Track a report by tracking ID (public)
...
// PATCH /api/reports/:id/status - Update report status (staff/admin only)
...
// POST /api/reports/:id/respond - Add a response to a report (staff/admin only)
...
// POST /api/reports/:id/actions - Combined endpoint for status update and/or response
